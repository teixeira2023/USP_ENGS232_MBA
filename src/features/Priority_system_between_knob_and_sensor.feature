Feature: Priority system between knob and sensor
    # In order to maintain visibility during rain
    # As a driver
    # I want the wiper mechanism to effectively clear the windshield
    ...
    Scenario Outline: healing failed signals
        ...
        Examples:
            ...
            | Knob   | off       | healed      | no_error  | active                |
            | Knob   | slow      | healed      | no_error  | active                |
            | Knob   | medium    | healed      | no_error  | active                |
            | Knob   | fast      | healed      | no_error  | active                |
